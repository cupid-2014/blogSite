...
* (WebController.login?-->)FormAuthenticationFilter.createToken-->ManagerUserShiroRealm.doGetAuthenticationInfo-->FormAuthenticationFilter.onLoginSuccess(-->WebController.login?)
