...
* WebController.login(保存相关信息到session) --> FormAuthenticationFilter.createToken --> ManagerUserShiroRealm.doGetAuthenticationInfo --> FormAuthenticationFilter.onLoginSuccess(从session中读取登录成功后的动作)
